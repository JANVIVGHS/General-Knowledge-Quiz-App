        ...
        NavigationStack {
            VStack(spacing: 40) {
                ...
                VStack(spacing: 20) {
                    ...
                    NavigationLink(destination: Level4View(), isActive: $goToNextLevel) {
                        EmptyView()
                    }
                    Button(action: {
                        goToNextLevel = true
...
struct Score3View_Previews: PreviewProvider {
    static var previews: some View {
        Score3View(score: 4, total: 5)
    }
}
