    ...
    var body: some View {
        NavigationStack {
            VStack(spacing: 40) {
                ...
                VStack(spacing: 20) {
                    NavigationLink(destination: Level2View(), isActive: $goToNextLevel) {
                        EmptyView()
                    }
                    Button(action: {
                        goToNextLevel = true
...
struct Score1View_Previews: PreviewProvider {
    static var previews: some View {
        Score1View(score: 4, total: 5)
    }
}
