        ...
        NavigationStack {
            VStack(spacing: 40) {
                ...
                VStack(spacing: 20) {
                    ...
                    NavigationLink(destination: Level6View(), isActive: $goToNextLevel) {
                        EmptyView()
                    }
                    Button(action: {
                        goToNextLevel = true
...
struct Score5View_Previews: PreviewProvider {
    static var previews: some View {
        Score5View(score: 4, total: 5)
    }
}
