        ...
        NavigationStack {
            VStack(spacing: 40) {
                ...
                VStack(spacing: 20) {
                    ...
                    NavigationLink(destination: Level5View(), isActive: $goToNextLevel) {
                        EmptyView()
                    }
                    Button(action: {
                        goToNextLevel = true
...
struct Score4View_Previews: PreviewProvider {
    static var previews: some View {
        Score4View(score: 4, total: 5)
    }
}
